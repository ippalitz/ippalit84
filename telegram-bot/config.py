...
ODIROUTER_BASE_URL = os.getenv("ODIROUTER_BASE_URL", "https://api.odirouter.ai/v1")
ODIROUTER_MODEL = os.getenv("ODIROUTER_MODEL", "")
ODIROUTER_TIMEOUT = int(os.getenv("ODIROUTER_TIMEOUT", "45"))
ODIROUTER_MAX_TOKENS = int(os.getenv("ODIROUTER_MAX_TOKENS", "350"))
